      ...
      <p className="ph">
        <div className="phh">
          ...
          <div className="ph2">
            ...
            <div className="ph2b">
              I've been a member of Heritage Financial Credit Union
            </div>
            <div className="ph2c">
              for over five years now, and i can confidently say{" "}
            </div>
            <div className="ph2c">
              say that it's been a fantastic financial partner.
            </div>
            <div className="ph2c">
              From day one, their commitment to personalized service
            </div>
            <div className="ph2c">
              {" "}
              and member satisfaction has been evident in every interaction.
            </div>
            <div className="ph2c">
              Overall, i couldn't be happier with my experience at
            </div>
            <div className="ph2c">
              Heritage Financial Credit Union. They've exceeded
            </div>
            <div className="ph2c">
              my expectation in every aspect, and I wouldn't hesiatte
            </div>
            <div className="ph2c">
              to recommend them to anyone looking for a trustworthy
            </div>
            <div className="ph2c">financial institution.</div>
            <div className="ph2d">- Ty Burrell</div>
            <div className="ph2e">
              <IoIosArrowDropleftCircle className="ph2e1" />
              <IoIosArrowDroprightCircle className="ph2e2" />
            </div>
          </div>
        </div>
      </p>
