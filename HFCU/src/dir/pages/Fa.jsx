      ...
      <table className="ad2">
        <thead className="ad2a">
          <tr>
            ...
            <th className="ad2b3">Freeze</th>
            <th className="ad2b4">Unfreeze</th>
          </tr>
        </thead>
        ...
        <tr>
          ...
          <td className='ad2c3'><button className="ad2c55">Freeze</button></td>
          <td className='ad2c4'>
          <button className="ad2c55">Unfreeze</button>
          </td>
        </tr>
        </tbody>
      </table>
